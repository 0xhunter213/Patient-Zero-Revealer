...
def PSSMBexec_detection(es,user=None,ip_source=None,timestamp=None,all=False):
    '''
    ...
    events_sercice_installed = event_searching(es=es,query=search_query,all=True)
    returned_event = None
    returned_events = []
    if events_sercice_installed:
        for event in events_sercice_installed:
            ...
            event_4624 = event_searching(es=es,query=search_query_event_4624)
            event_3 = event_searching(es=es,query=search_query_event_3)
